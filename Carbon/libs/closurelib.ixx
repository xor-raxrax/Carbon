...
int carbon_iscclosure(lua_State* L);
int carbon_islclosure(lua_State* L);
int carbon_newcclosure(lua_State* L);
int carbon_clonefunction(lua_State* L);

int carbon_hookfunction(lua_State* L);
int carbon_hookmetamethod(lua_State* L);
int carbon_isfunctionhooked(lua_State* L);
int carbon_restorefunction(lua_State* L);

int carbon_setourclosure(lua_State* L);
int carbon_isourclosure(lua_State* L);

int carbon_setsafeenv(lua_State* L);

int carbon_getstack(lua_State* L);
int carbon_setstack(lua_State* L);

int carbon_getmaxstacksize(lua_State* L);
int carbon_getstacksize(lua_State* L);

int carbon_getupvalues(lua_State* L);
int carbon_getupvalue(lua_State* L);
int carbon_setupvalue(lua_State* L);

int carbon_getconstants(lua_State* L);
int carbon_getconstant(lua_State* L);
int carbon_setconstant(lua_State* L);

int carbon_getprotoinfo(lua_State* L);
int carbon_getprotos(lua_State* L);
int carbon_getproto(lua_State* L);
export int carbon_setproto(lua_State* L);
int carbon_getinfo(lua_State* L);

export const luaL_Reg closureDebugLibrary[] = {
	{"getstack", carbon_getstack},
	{"setstack", carbon_setstack},

	{"getmaxstacksize", carbon_getmaxstacksize},
	{"getstacksize", carbon_getstacksize},

	{"getupvalue", carbon_getupvalue},
	{"setupvalue", carbon_setupvalue},
	{"getupvalues", carbon_getupvalues},

	{"getconstants", carbon_getconstants},
	{"getconstant", carbon_getconstant},
	{"setconstant", carbon_setconstant},

	{"getprotos", carbon_getprotos},
	{"getproto", carbon_getproto},

	{"getinfo", carbon_getinfo},
	{"getprotoinfo", carbon_getprotoinfo},

	{nullptr, nullptr},
};

export const luaL_Reg closureLibrary[] = {
	{"setsafeenv", carbon_setsafeenv},

	{"iscclosure", carbon_iscclosure},
	{"islclosure", carbon_islclosure},
	{"setourclosure", carbon_setourclosure},
	{"isourclosure", carbon_isourclosure},

	{"newcclosure", carbon_newcclosure},
	{"clonefunction", carbon_clonefunction},

	{"hookfunction", carbon_hookfunction},
	{"hookmetamethod", carbon_hookmetamethod},
	{"isfunctionhooked", carbon_isfunctionhooked},
	{"restorefunction", carbon_restorefunction},
...
int carbon_setproto(lua_State* L)
{
	Closure* func = getclosure(L, 1, true);
	expectLuaFunction(L, *func);
